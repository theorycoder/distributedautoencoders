...
for i in range(len(eps)):
    if i==0:
        accuracy=np.loadtxt("results/FMaccuracy_noislessInp_0.txt") 
    elif i==1:
    ...
    if i==0:
        accuracy=np.loadtxt("results/dpsgdaccuracy_0_1_0_1.txt") #noiseless
    elif i==1:
        accuracy=np.loadtxt("results/dpsgdaccuracy_1_1_0_1.txt") 
    elif i==2:
        accuracy=np.loadtxt("results/dpsgdaccuracy_2_1_0_1.txt") 
    elif i==3:
        accuracy=np.loadtxt("results/dpsgdaccuracy_3_1_0_1.txt") 
    elif i==4:
        accuracy=np.loadtxt("results/dpsgdaccuracy_4_1_0_1.txt") 
    accuracy=array(accuracy).reshape(1, -1)
    dpsgd2[i]=accuracy.mean(1)
    
    if i==0:
        accuracy=np.loadtxt("results/dpsgdaccuracy_0_1_1_5.txt") 
    elif i==1:
        accuracy=np.loadtxt("results/dpsgdaccuracy_1_1_1_5.txt") 
    elif i==2:
        accuracy=np.loadtxt("results/dpsgdaccuracy_2_1_1_5.txt") 
    elif i==3:
        accuracy=np.loadtxt("results/dpsgdaccuracy_3_1_1_5.txt") 
    elif i==4:
        accuracy=np.loadtxt("results/dpsgdaccuracy_4_1_1_5.txt") 
    accuracy=array(accuracy).reshape(1, -1)
...
for i in range(len(eps)):
    if i==0:
        time=np.loadtxt("results/nonPrivate_time_0_0_0_1.txt") 
    elif i==1:
        time=np.loadtxt("results/nonPrivate_time_1_0_0_1.txt") 
    elif i==2:
        time=np.loadtxt("results/nonPrivate_time_2_0_0_1.txt") 
    elif i==3:
        time=np.loadtxt("results/nonPrivate_time_3_0_0_1.txt") 
    elif i==4:
        time=np.loadtxt("results/nonPrivate_time_4_0_0_1.txt") 
    time=array(time).reshape(1, -1)
    nonprivate_time[i]=time.mean(1)


for i in range(len(eps)):
    if i==0:
        time=np.loadtxt("results/fm_time_0_1_0_1.txt") 
    elif i==1:
        time=np.loadtxt("results/fm_time_1_1_0_1.txt") 
    elif i==2:
        time=np.loadtxt("results/fm_time_2_1_0_1.txt") 
    elif i==3:
        time=np.loadtxt("results/fm_time_3_1_0_1.txt") 
    elif i==4:
        time=np.loadtxt("results/fm_time_4_1_0_1.txt") 
    time=array(time).reshape(1, -1)
    FM_time[i]=time.mean(1)


for i in range(len(eps)):
    if i==0:
        time=np.loadtxt("results/dpsgd_time_0_1_0_1.txt") 
    elif i==1:
        time=np.loadtxt("results/dpsgd_time_1_1_0_1.txt") 
    elif i==2:
        time=np.loadtxt("results/dpsgd_time_2_1_0_1.txt") 
    elif i==3:
        time=np.loadtxt("results/dpsgd_time_3_1_0_1.txt") 
    elif i==4:
        time=np.loadtxt("results/dpsgd_time_4_1_0_1.txt") 
    time=array(time).reshape(1, -1)
    dpsgd_time[i]=time.mean(1)
...
# Plot using indices
plt.plot(x_indices,nonprivate,'-.o',x_indices,FM_noiseless,'-.*',x_indices,FM_noisy,'-.<',x_indices,FM_noisy2,'-.d', x_indices,dpsgd2,'-.s',
x_indices,dpsgd3,'-.x',linewidth=3,markersize =10) 
# Set custom x-ticks with original x-values
plt.xticks(x_indices, eps)

diff1=(dpsgd2.mean(0)-FM_noiseless.mean(0))*100
print('diff1: ',diff1)
diff2=(dpsgd_time.mean(0)-FM_time.mean(0))*100
print('dpsgd_time: ',dpsgd_time)

time_diff1=(dpsgd_time.mean(0)-FM_time.mean(0))/dpsgd_time.mean(0)*100
print('time_diff1: ',time_diff1)
#time_diff2=(nonprivate_time.mean(0)-FM_time.mean(0))*100
...
plt.gca().legend(('non-private (standard BP)',
				  ...
				  loc="center", bbox_to_anchor=(0.5, 0.4), borderaxespad=0.,labelspacing=0.25
				  )
#plt.show()
