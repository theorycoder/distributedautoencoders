...
for i in range(len(eps)):
    ...
    #dpsgd using custom loss, C=4, delta_sgd=2nlog2
    if i==0:
        accuracy=np.loadtxt("results/dpsgdaccuracy_0_1.txt") 
    elif i==1:
        accuracy=np.loadtxt("results/dpsgdaccuracy_1_1.txt") 
    elif i==2:
        accuracy=np.loadtxt("results/dpsgdaccuracy_2_1.txt") 
    elif i==3:
        accuracy=np.loadtxt("results/dpsgdaccuracy_3_1.txt") 
    elif i==4:
        accuracy=np.loadtxt("results/dpsgdaccuracy_4_1.txt") 
    elif i==5:
        accuracy=np.loadtxt("results/dpsgdaccuracy_5_1.txt") 
    elif i==6:
        accuracy=np.loadtxt("results/dpsgdaccuracy_6_1.txt") 
    accuracy=array(accuracy).reshape((1,14))
    dpsgd[i]=accuracy.mean(1)
    ...
    if i==0:
        ...
        accuracy=np.loadtxt("results/dpsgdaccuracy_5_1_1_5.txt") 
    elif i==6:
        accuracy=np.loadtxt("results/dpsgdaccuracy_6_1_1_5.txt") 
    accuracy=array(accuracy).reshape((1,7))
    dpsgd2[i]=accuracy.mean(1)
    
    #dpsgd using built-in loss, C=4, delta_sgd=2nlog2,
    if i==0:
        accuracy=np.loadtxt("results/dpsgdaccuracy_0_1_1_5.txt") #noiseless
    elif i==1:
        accuracy=np.loadtxt("results/dpsgdaccuracy_1_1_1_5.txt") 
    elif i==2:
        accuracy=np.loadtxt("results/dpsgdaccuracy_2_1_1_5.txt") 
    ...
    #using deltaFM
    if i==0:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp00.txt") 
    elif i==1:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp10.txt") 
    elif i==2:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp20.txt") 
    elif i==3:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp3.txt") 
    elif i==4:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp4.txt") 
    elif i==5:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp5.txt") 
    elif i==6:
        accuracy=np.loadtxt("results/FMaccuracy_noisyInp6.txt") 
    accuracy=array(accuracy).reshape((1,7))
    FM_noisy2[i]=accuracy.mean(1)
    '''
...
plt.plot(x_indices,nonprivate,'-.o',x_indices,FM_noiseless,'-.*',x_indices,FM_noisy,'-.<',x_indices,FM_noisy2,'-.s',
         x_indices,dpsgd,'-.x',x_indices,dpsgd3,'-.x',linewidth=3,markersize =10) 
# Set custom x-ticks with original x-values
plt.xticks(x_indices, eps)

diff1=(dpsgd.mean(0)-FM_noiseless.mean(0))*100
print('diff1: ',diff1)
